...
/**
 * Clases de error personalizadas para la API.
...
class AppError extends Error {
  constructor(message, statusCode = 500, code = 'INTERNAL_ERROR') {
    ...
    this.code       = code;
    this.isOperational = true;   // No es un bug, es un error esperado del negocio
...
class TenantIsolationError extends AppError {
  constructor() {
    super('Acceso denegado: el recurso no pertenece a su empresa', 403, 'TENANT_ISOLATION');
  }
}
